...
function badGame ( game ) {
	...
	if (game.search(/Final Fantasy XIV Online/i) > -1) { return true; }	
	if (game.search(/Fortune Street/i) > -1) { return true; }
	if (game.search(/Guild Wars/i) > -1) { return true; }
	if (game.search(/Guitar Hero/i) > -1) { return true; }
	if (game.search(/Hatsune Miku: Project Diva/i) > -1) { return true; }
